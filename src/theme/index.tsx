...
export function colors(darkMode?: boolean): Colors {
  return {
    ...
    bodyBg: darkMode ? "linear-gradient(201.32deg, #222429 -48.82%, #232429 51.35%)" : 'linear-gradient(201.32deg, #fff -48.82%, #fff 51.35%)',
    splashBG: darkMode ? 'linear-gradient(201.32deg, #4E5780 -48.82%, #232429 51.35%)' : "linear-gradient(201.32deg, #d4daf2 -48.82%, #fff 51.35%)",
