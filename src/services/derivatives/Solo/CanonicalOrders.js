...
import {addressToBytes32, argToBytes, bytesToHexString, hashString, stripHexPrefix, toBytes, toString} from "./lib/helpers";
...
export class CanonicalOrders extends OrderSigner {
    ...
    orderToBytes(
        ...
        return !!(order.typedSignature)
            ? `${orderAndTradeHex}${stripHexPrefix(order.typedSignature)}`
            : orderAndTradeHex;
    }
