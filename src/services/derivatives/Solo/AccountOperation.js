import {
    ActionType,
    AmountDenomination,
    AmountReference, ConfirmationType,
...
export class AccountOperation {
    ...
    approveStopLimitOrder(args) {
        this.addActionArgs(
            args,
            {
                ...
                data: toBytes(
                    LimitOrderCallFunctionType.Approve,
                    this.stopLimitOrders.unsignedOrderToBytes(args.order),
                ),
            },
        );
        return this;
    ...
    approveCanonicalOrder(args) {
        this.addActionArgs(
            args,
            {
                ...
                data: toBytes(
                    LimitOrderCallFunctionType.Approve,
                    this.canonicalOrders.orderToBytes(args.order),
                ),
            },
        );
        return this;
    ...
    liquidateExpiredAccountInternal(
        liquidate,
        maxExpiryTimestamp,
        contractAddress,
    ) {
