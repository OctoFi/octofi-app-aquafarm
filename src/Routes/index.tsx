        ...
        <>
            ...
            {!loading && (!account ? (
                    <Switch>
                        ...
                        <Redirect from={'/instant-swap'} to={'/'} exact />
                ...
                <Layout>
                    <Switch>
                        ...
                        <Route path={'/coins/contract/:contract'} exact component={ContractDetails}/>
                        <Route path={'/coins/:id'} exact component={CoinDetails}/>
                        <Route path={'/buy'} exact component={BuyCrypto}/>
                        <Route path={'/instant-swap'} exact component={InstantSwap}/>
