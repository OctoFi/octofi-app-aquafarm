...
import walletTokens from '../../constants/walletTokens.json';

export const useLinkTokens = () => {
    return useMemo(() => {
        return Array.from(walletTokens).filter((token, index) => ![0, 27, 187, 208, 230, 232, 235, 244, 245].includes(index) || token.chainId !== 1).map(token => {
