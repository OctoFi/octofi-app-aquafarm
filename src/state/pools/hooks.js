    ...
    return [
        useMemo(
            () =>
                ...
                if (amount) {
                    memo[token] = (amount / (10 ** 18)).toFixed(6)
                }
                return memo
            }, {})
        : {},
...
export function usePoolApproveCallback(
    ...
    const inputs = useMemo(() => [account, spender || '0x79B6C6F8634ea477ED725eC23b7b6Fcb41F00E58'], [account, spender])
    ...
    const approve = useCallback(async () => {
      ...
      return tokenContract.functions.approve(spender, parsedAmountA)
        .then((response) => {
