...
import {
    buildLimitOrder,
    buildMarketLimitMatchingOrders, buildMarketOrders, calculateWorstCaseProtocolFee, cancelSignedOrder,
    getAllOrdersAsUIOrders,
    getUserOrdersAsUIOrders, sumTakerAssetFillableOrders
} from "../../utils/spot/orders";
import {getExpirationTimeOrdersFromConfig, todayInSeconds} from "../../utils/spot/timeUtils";
import {
    getBaseToken,
    getFeePercentage,
    getFeeRecipient, getGasInfo, getMarketMakerStats,
    getOpenBuyOrders,
    getOpenSellOrders,
    getQuoteToken
} from "../selectors";
...
export const fetchTakerAndMakerFee = (
    amount,
    price,
    side,
    account,
