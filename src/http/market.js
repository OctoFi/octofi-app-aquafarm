...
export default class MarketApi {
    ...
    fetchSearchedCoins(payload) {
        return axios.get(`${this.baseURL}/coins/markets?vs_currency=USD&price_change_percentage=1h,24h,7d,30d,60d,200d,1y&ids=${payload.ids.join(",")}&sparkline=true&per_page=${payload.pageSize || 10}&page=${payload.page || 1}`)
    }

    fetchMarketCoins() {
        return axios.get(`${this.baseURL}/coins/markets?vs_currency=USD&price_change_percentage=1h,24h,7d,30d,60d,200d,1y&ids=${this.ids.join(",")}&sparkline=true`)
    }
    ...
    fetchAllCoins(payload) {
        return axios.get(`${this.baseURL}/coins/markets?vs_currency=USD&price_change_percentage=1h,24h,7d,30d,60d,200d,1y&per_page=${payload.pageSize}&page=${payload.page}&sparkline=true`)
    }
    ...
    fetchContractHistorical(payload) {
        return axios.get(`${this.baseURL}/coins/ethereum/contract/${payload.address}/market_chart?vs_currency=USD&days=${payload.days}`)
    }
