...
const ordersToUIOrdersWithoutOrderInfo = (orders, baseToken) => {
    ...
    return orders.map((order, i) => {
        const makerAssetAddress = assetDataUtils.decodeAssetDataOrThrow(order.makerAssetData)
    .tokenAddress;
        ...
        const takerAssetAddress = assetDataUtils.decodeAssetDataOrThrow(order.takerAssetData)
    .tokenAddress;
