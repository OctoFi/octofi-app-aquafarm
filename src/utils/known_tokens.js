...
export class KnownTokens {
    ...
    isValidFillEvent = (fillEvent) => {
        ...
        const makerAssetAddress = assetDataUtils.decodeAssetDataOrThrow(makerAssetData)
    .tokenAddress;
        const takerAssetAddress = assetDataUtils.decodeAssetDataOrThrow(takerAssetData)
    .tokenAddress;
