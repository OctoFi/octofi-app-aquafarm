                        ...
                        <div>
                            <Form>
                                <FormRow className={'custom-row'}>
                                    ...
                                    <FormGroup as={Col} className={'d-flex flex-column flex-md-row align-items-stretch align-items-md-center justify-content-center mb-0'}>
                                        <button
                                        ...
                                        >
                                            {!account ? 'Connect Wallet' : loading ? (
                                                <div className={'d-flex align-items-center justify-content-center w-100'}>
                                                    <Loading width={18} height={18} active={true} color={'#fff'} id={'create-proposal'}/>
                                                </div>
                                            ) : t('publish')}
                                        </button>
                                    </FormGroup>
