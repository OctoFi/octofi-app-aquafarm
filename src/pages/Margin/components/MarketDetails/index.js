    ...
    if(!account || !selectedMarket || !marketStats) {
        ...
        const columns = [
            ...
            },
            {
                ...
                formatter: (cellContent, row) => {
                    return (
                        <Text>{row?.marketStats?.price || '-'}</Text>
                    )
                },
            },
            {
        ...
        content = (
            <>
                <BootstrapTable
                    ...
                    columns={columns}
                />
                <ResponsiveTable breakpoint={'lg'} columns={columns} data={[{marketStats: marketStats}]} direction={'rtl'} withoutBorder/>
            </>
        )
    }
