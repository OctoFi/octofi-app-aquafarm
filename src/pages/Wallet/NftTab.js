    ...
    const columns = [
        {
            ...
            formatter: (cellContent, row) => {
                return (
                    <CustomText>{row.token_id}</CustomText>
                )
            },
        },
        {
                ...
                return (
                    <div className="d-flex align-items-center flex-row-reverse flex-lg-row">
                        ...
                        <div className="d-flex flex-column align-items-end align-items-lg-start">
                            ...
                            <CustomText>{row.description}</CustomText>
                        </div>
                    </div>
                )
            },
        ...
        },
        {
            ...
            formatter: (cellContent, row) => {
                return (
                    <div className="d-flex align-items-center flex-row-reverse flex-lg-row">
                        <CustomText>{moment(row.asset_contract.created_date).format('YYYY-MM-DD HH:mm:ss')}</CustomText>
                    </div>
                )
            },
        },
