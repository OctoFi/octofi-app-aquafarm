...
import {presaleAddresses, UNLIMITED_ALLOWANCE_IN_BASE_UNITS, ZERO_ADDRESS} from "../../constants";
...
const NewLaunchpad = props => {
    ...
    const [baseToken, setBaseToken] = useState(WETH[chainId]);
                                            ...
                                            <DescriptionCard className={'d-flex flex-column'}>
                                                ...
                                                <Row className={'mt-5 custom-row'}>
                                                    <Col xs={12} md={6} lg={4} className={'d-flex flex-column'}>
                                                        <InnerCardLabel>Defi Dashboard Fee</InnerCardLabel>
