                    ...
                    <Col xs={12} className={'gutter-b'}>
                        <CustomCard>
                            <div className="card-body d-flex align-items-center justify-content-between">
                                <CustomTitle className={'card-title text-muted mb-0'}>Your "{selected.name}" Balance</CustomTitle>
                                <div className="card-title mb-0 font-weight-bold font-size-lg">{selected.symbol.toUpperCase()} {walletBalance.toFixed(6)} <span className="text-muted">(<CurrencyText>{walletBalance * selected.market_data.current_price.usd}</CurrencyText>)</span></div>
                            </div>
                        </CustomCard>
                    </Col>
                )}
                        ...
                        {selected && selected.contract_address && (
                            <CustomHeader className="card-header d-flex align-items-center justify-content-between">
                                ...
                                <div className="d-flex align-items-center justify-content">
                                    <Link to={`/swap/uni?outputCurrency=${selected.contract_address}`} className="btn btn-outline-success mr-2">Buy</Link>
                                    <Link to={`/swap/uni?inputCurrency=${selected.contract_address}`} className="btn btn-outline-danger">Sell</Link>
                                </div>
                            </CustomHeader>
                        )}
