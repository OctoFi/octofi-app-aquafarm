            ...
            {props.loading ? (
                ...
                <>
                    <Row className={'custom-row'}>
                        <Col xs={12} md={4}>
                            <ValueCard className={'gutter-b'} color={'secondary2'} title={t('totalAssets')} value={props.overview.deposits.total + props.overview.wallet.total} type={'assets'}/>
                        </Col>
                        <Col xs={12} md={4}>
                            <ValueCard className={'gutter-b'} title={t('totalDebts')} value={props.overview.debts.total} type={'debts'}/>
                        </Col>
                        <Col xs={12} md={4}>
                            <ValueCard className={'gutter-b'} color={'secondary2'} title={t('netWorth')} value={props.overview.deposits.total + props.overview.wallet.total - props.overview.debts.total} type={'netWorth'}/>
                        </Col>
                    </Row>
                    <Row>
                        <Col>
                        ...
                        {props.transformedBalance.length > 0 ? props.transformedBalance.map((b, index) => {
                            ...
                            <Col xs={12}>
                                <Card className="d-flex flex-column align-items-center justify-content-center py-8 px-4">
                                    <SVG src={require('../../assets/images/global/layout-block.svg').default} width={64} height={64} />
