...
const TokenSetTab = props => {
    ...
    const columns = [
        ...
        },
        {
            ...
            formatter: (cellContent, row, index, { historical }) => {
                ...
                return (
                    <CellText className={`label px-3 px-lg-2 label-inline label-lg ${h?.market_data?.price_change_percentage_24h >= 0 ? 'label-light-success' : 'label-light-danger'} `}>
                        ...
                        {h.market_data?.price_change_percentage_24h && h?.market_data?.price_change_percentage_24h.toFixed(2) + '%' || '-'}
                    </CellText>
                )
            },
            formatExtraData: {
        ...
        },
        {
            ...
            formatter: (cellContent, row, index, { historical }) => {
                ...
                return (
                    <CellText className={`label px-3 px-lg-2 label-inline label-lg ${h?.market_data?.price_change_percentage_7d >= 0 ? 'label-light-success' : 'label-light-danger'} `}>
                        <span className="mr-2 d-none d-lg-flex">
                        ...
                        {h.market_data?.price_change_percentage_7d && h?.market_data?.price_change_percentage_7d.toFixed(2) + '%' || '-'}
                    </CellText>
                )
            },
            formatExtraData: {
        ...
        },
        {
            ...
            formatter: (cellContent, row, index, { historical }) => {
                ...
                return (
                    <CellText className={`label px-3 px-lg-2 label-inline label-lg ${h?.market_data?.price_change_percentage_30d >= 0 ? 'label-light-success' : 'label-light-danger'} `}>
                        <span className="mr-2 d-none d-lg-flex">
                        ...
                        {h.market_data?.price_change_percentage_30d && h?.market_data?.price_change_percentage_30d.toFixed(2) + '%' || '-'}
                    </CellText>
                )
            },
            formatExtraData: {
        ...
        },
        {
            ...
            formatter: (cellContent, row, index, { historical }) => {
                ...
                return (
                    <CellText className={`label px-3 px-lg-2 label-inline label-lg ${h?.market_data?.price_change_percentage_200d >= 0 ? 'label-light-success' : 'label-light-danger'} `}>
                        <span className="mr-2 d-none d-lg-flex">
                        ...
                        {h.market_data?.price_change_percentage_200d && h?.market_data?.price_change_percentage_200d.toFixed(2) + '%' || '-'}
                    </CellText>
                )
            },
            formatExtraData: {
        ...
        },
        {
            ...
            formatter: (cellContent, row, index, { historical }) => {
                ...
                return (
                    <CellText className={`label px-3 px-lg-2 label-inline label-lg ${h?.market_data?.price_change_percentage_1y >= 0 ? 'label-light-success' : 'label-light-danger'} `}>
                        <span className="mr-2 d-none d-lg-flex">
                        ...
                        {h.market_data?.price_change_percentage_1y && h?.market_data?.price_change_percentage_1y.toFixed(2) + '%' || '-'}
                    </CellText>
                )
            },
            formatExtraData: {
    ...
    const rowEvents = {
        onClick: (e, row) => {
            window.open(`https://www.tokensets.com/${tabKey === 'portfolios' ? 'portfolio' : 'set'}/${row.id}`, '_blank')
        }
    }
