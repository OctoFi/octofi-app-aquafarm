						...
						<Wrapper id="swap-page">
							...
							<Row>
								...
								<Col
									xs={12}
									className={
										"d-flex flex-column align-items-stretch align-items-lg-center justify-content-center  mb-lg-0"
									}
								...
								>
									{!account ? (
										...
										<Button
											variant={"outline-primary"}
											disabled={true}
											className={"mb-2 py-3 font-weight-bold"}
										>
										...
										<Row className={"flex-grow-1"}>
											...
											>
												<Button
													...
													className={`py-3 flex-grow-1 btn ${
														approval === ApprovalState.PENDING
															? "btn-light-secondary"
															: "btn-secondary-light"
													}`}
												...
												<ApproveArrow className={"d-none d-lg-block"}>
													<SVG
														src={
															require("../../assets/images/global/arrow-right-long.svg")
																.default
														}
													/>
												</ApproveArrow>
												<ApproveArrow className={"d-block d-lg-none"}>
													<SVG
														src={
															require("../../assets/images/global/arrow-down-long.svg")
																.default
														}
													/>
												</ApproveArrow>
							...
							<Row>
								{trade && (
									<Col
										xs={12}
										className={
											"d-flex flex-column align-items-stretch align-items-lg-center justify-content-center"
										}
									>
										<a
											href={
											...
											className={"btn btn-outline-primary mb-lg-0"}
											style={{ padding: "1rem 2.75rem", marginTop: "3.25rem", marginBottom: 50 }}
										>
											{t("viewPairAnalytics")} ↗
										</a>
									</Col>
