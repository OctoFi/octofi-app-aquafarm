                    ...
                    <Col xs={12} className={'gutter-b'}>
                        <BalanceCard marginTop={-30}>
                            <div className="d-flex flex-column flex-lg-row align-items-stretch align-items-lg-center justify-content-between">
                                ...
                                <BalanceValue>{selected.symbol.toUpperCase()} {walletBalance.toFixed(6)} (<CurrencyText>{walletBalance * selected.market_data.current_price.usd}</CurrencyText>)</BalanceValue>
                            </div>
                        </BalanceCard>
                    </Col>
                )}
                    ...
                    <ChartResponsiveCard marginTop={walletBalance !== 'boolean' ? 0 : -30}>
                        {selected && selected.contract_address && (
                            <div className="d-flex flex-column flex-lg-row align-items-stretch align-items-lg-center justify-content-between mb-4">
                                <BuyHelper className={'font-weight-normal font-size-base'}>Exchange {selected.name}?</BuyHelper>
                                <div className="d-flex align-items-center justify-content">
                                    <BuyLink to={`/swap/uni?outputCurrency=${selected.contract_address}`} className="mr-4"><GradientButton style={{ minWidth: 125}}>Buy</GradientButton></BuyLink>
                                    <BuyLink to={`/swap/uni?inputCurrency=${selected.contract_address}`}><GradientButton style={{ minWidth: 125}}>Sell</GradientButton></BuyLink>
                                </div>
                            </div>
                        )}
            ...
            <Row className={'custom-row d-flex align-items-stretch'}>
                <Col lg={3} md={6} xs={12} className={'gutter-b'}>
                    <ResponsiveCol>
                        ...
                        <StyledChangesCard className={'d-flex flex-column flex-lg-row align-items-center justify-content-center justify-content-lg-start'}>
                            <div className="d-flex align-items-center">
                                ...
                                <ChangesTitle className={selected && selected.market_data.price_change_percentage_24h >= 0 ? 'text-success' : 'text-danger'}>
                    ...
                    <ResponsiveCol>
                        <StyledChangesCard className={'d-flex flex-column flex-lg-row align-items-center justify-content-center justify-content-lg-start'}>
                            <div className="d-flex align-items-center">
                                ...
                                <ChangesTitle className={selected && selected.market_data.price_change_percentage_7d >= 0 ? 'text-success' : 'text-danger'}>
                    ...
                    <ResponsiveCol>
                        <StyledChangesCard className={'d-flex flex-column flex-lg-row align-items-center justify-content-center justify-content-lg-start'}>
                            <div className="d-flex align-items-center">
                                ...
                                <ChangesTitle className={selected && selected.market_data.price_change_percentage_30d >= 0 ? 'text-success' : 'text-danger'}>
                    ...
                    <ResponsiveCol>
                        <StyledChangesCard className={'d-flex flex-column flex-lg-row align-items-center justify-content-center justify-content-lg-start'}>
                            <div className="d-flex align-items-center">
                                ...
                                <ChangesTitle className={selected && selected.market_data.price_change_percentage_1y >= 0 ? 'text-success' : 'text-danger'}>
                    ...
                    <ResponsiveCol>
                        <StyledCard header={true} title={'Coin Stats'}>
                            <div className="d-flex align-items-center justify-content-between row pb-0 pb-lg-2">
                                <Col xs={12} md={4} className={'d-flex flex-row flex-lg-column align-items-center align-items-lg-start justify-content-between justify-content-lg-center '}>
                                ...
                                <Col xs={12} md={4} className={'d-flex flex-row flex-lg-column align-items-center align-items-lg-start justify-content-between justify-content-lg-center '}>
                                    ...
                                    <StatsValue className="text-success">${selected && selected.market_data.ath.usd}</StatsValue>
                                </Col>
                                <Col xs={12} md={4} className={'d-flex flex-row flex-lg-column align-items-center align-items-lg-start justify-content-between justify-content-lg-center '}>
                                    <StatsDesc last>All Time Low</StatsDesc>
                                    <StatsValue last className="text-danger">${selected && selected.market_data.atl.usd}</StatsValue>
                                </Col>
                            </div>
                        </StyledCard>
                    </ResponsiveCol>
                ...
                <Col xs={12} className={'gutter-b'}>
                    <ResponsiveCol>
                        <StyledCard header={true} title={'About'}>
                            <About dangerouslySetInnerHTML={{__html: selected && selected.description.en}} />
                        </StyledCard>
                    </ResponsiveCol>
                </Col>
                <Col xs={12} className={'gutter-b'}>
                            ...
                            <Row>
                                <DetailsCol xs={12} md={6}>
                                    <Row className={'d-flex flex-row align-items-center justify-content-between'}>
                                        ...
                                        <DetailsInnerCol lg={8} className={'d-flex align-items-center justify-content-end justify-content-lg-start'}>
                                    ...
                                    <Row className={'d-flex flex-row align-items-center justify-content-between'}>
                                        ...
                                        <DetailsInnerCol lg={8} className={'d-flex align-items-center justify-content-end justify-content-lg-start'}>
                                            <DetailsLink
                                                ...
                                                target={"_blank"}
                                                rel={'noopener noreferrer'}>{selected && selected.links.homepage[0]}</DetailsLink>
                                        </DetailsInnerCol>
                                    </Row>
                                </DetailsCol>
                                <DetailsCol xs={12} md={6}>
