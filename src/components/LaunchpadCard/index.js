...
const LaunchpadCard = ({ address, presale }) => {
    ...
    return (
        <Wrapper to={`/invest/launchpad/${address}`}>
            ...
            <Row>
                <Pair>{baseToken?.symbol} / {selectedToken?.symbol}</Pair>
            ...
            <Row>
                ...
                <div className="d-flex flex-column align-items-center">
                    ...
                    <Value>{isNaN(maxSpend) ? "-" : maxSpend} {baseToken?.symbol || ""}</Value>
                </div>
                <div className="d-flex flex-column align-items-end">
                    <Label align={'right'}>Soft cap</Label>
                    <Value align={'right'}>{isNaN(softCap) ? '-' : softCap} {baseToken?.symbol || ""}</Value>
                </div>
            </Row>
            <Row>
