    ...
    <>
      <UpperSection>
                  ...
                  <>
                    <AccountControl>
                        ...
                        {chainId && account && (
                          ...
                          >
                            <SVG src={require('../../assets/images/account/external-link.svg').default} />
                            <WalletButtons style={{ marginLeft: '10px' }}>View on Etherscan</WalletButtons>
                          </AddressLink>
                        )}
                    </AccountControl>
                  </>
        ...
        <ChangeAccountContainer>
          <button className="btn btn-secondary-light d-block d-xl-none btn-block w-100 py-3" onClick={openOptions}>
            Change
          </button>
        </ChangeAccountContainer>
      </UpperSection>
