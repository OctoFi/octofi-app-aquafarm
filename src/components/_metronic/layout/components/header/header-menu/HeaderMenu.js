...
export function HeaderMenu({ layoutProps }) {
    ...
    >
        ...
        <ul className={`menu-nav ${layoutProps.ulClasses}`}>
            ...
            {/*end::1 Level*/}
            {/*begin::1 Level*/}
            <li className={`menu-item menu-item-rel ${getMenuItemActive('/instant-swap')}`}>
                <NavLink className="menu-link" to="/instant-swap">
                    <span className="menu-text">Instant Swap</span>
                    {layoutProps.rootArrowEnabled && (<i className="menu-arrow" />)}
                </NavLink>
            </li>
            {/*end::1 Level*/}
