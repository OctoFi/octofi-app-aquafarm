          ...
          {layoutProps.light && (
            <>
              <div className="d-flex align-items-center p-8 rounded-top">
                ...
                <span onClick={copyAccountToClipboard} className="btn btn-light-success btn-sm font-weight-bold" ref={copyTarget}>
                  {isCopying ? (<Check size={18}/>) : "Copy"}
                </span>

                <Overlay target={copyTarget.current} show={isCopying} placement="top">
                  {({ placement, arrowProps, show: _show, popper, ...props }) => (
                      <div
                          {...props}
                          className={'label label-lg label-dark label-inline py-4'}
                          style={{
                            zIndex: 9999999,
                            ...props.style,
                          }}
          ...
          {!layoutProps.light && (
            ...
            >
              ...
              <span onClick={copyAccountToClipboard} className="btn btn-light-success btn-sm font-weight-bold">
                  {isCopying ? (<Check size={18} fill={'#1BC5BD'}/>) : "Copy"}
                </span>
            </div>
          )}
        </>
          ...
          <a className="navi-item px-8" onClick={disconnectWalletHandler}>
            <div className="navi-link">
              ...
              <div className="navi-text">
                ...
                <div className="text-muted">Disconnect from AQUAFARM</div>
              </div>
            </div>
          </a>
