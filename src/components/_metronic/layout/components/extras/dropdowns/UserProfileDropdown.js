        ...
        <div className="navi navi-spacer-x-0 pt-5">
          ...
          <a className="navi-item px-8" href={getEtherscanLink(chainId, account, 'address')} target={"_blank"}>
            <div className="navi-link">
              ...
              <div className="navi-text">
                <div className="font-weight-bold">View on Etherscan </div>
          ...
          <a className="navi-item px-8" onClick={toggleWalletModal}>
            <div className="navi-link">
              ...
              <div className="navi-text">
                <div className="font-weight-bold">Change connection</div>
                <div className="text-muted">Connect to another wallet</div>
              </div>
            </div>
          </a>
          <div className="navi-footer  px-8 py-5">
            <div className="label label-light-primary label-lg font-weight-bold d-flex w-100 label-inline">
