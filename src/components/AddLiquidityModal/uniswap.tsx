                ...
                <Modal.Body style={{ padding: !showConfirm ? '30px' : '0' }}>
                    {!account ? (
                        ...
                        <Row>
                            ...
                            <Col xs={12} style={{ paddingTop: 30 }} className={'d-flex flex-column flex-xl-row align-items-stretch align-items-xl-center justify-content-center'}>
                                {!account && (
                                    <Button
                                        style={{ minWidth: 250 }}
                                        variant={'dark'} disabled className={'py-3 font-size-lg font-weight-bolder'}>{t('wallet.connect')}</Button>
                                )}
                                ...
                                <Button
                                    ...
                                    variant={!isValid && !!parsedAmounts[Field.CURRENCY_A] && !!parsedAmounts[Field.CURRENCY_B] ? 'outline-primary' : 'primary'}
                                    className={`${!isValid && !!parsedAmounts[Field.CURRENCY_A] && !!parsedAmounts[Field.CURRENCY_B] ? 'outline-primary' : ''} py-3`}
                                >
                                <span className="font-weight-bold font-size-lg">
                                    {error ?? t('pools.supply')}
                                </span>
