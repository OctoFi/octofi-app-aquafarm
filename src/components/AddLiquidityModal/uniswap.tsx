    ...
    const handleCurrencyASelect = useCallback(
        (currencyA: Currency) => {
            ...
            if (newCurrencyIdA === currencyIdB) {
                history.push(`/invest/${currencyIdB}/${currencyIdA}`, )
            } else {
                history.push(`/invest/${newCurrencyIdA}/${currencyIdB}`, )
            }
        },
    ...
    const handleCurrencyBSelect = useCallback(
        (currencyB: Currency) => {
            ...
            if (currencyIdA === newCurrencyIdB) {
                if (currencyIdB) {
                    history.push(`/invest/${currencyIdB}/${newCurrencyIdB}`, )
                } else {
                    history.push(`/invest/${newCurrencyIdB}`, )
                }
            } else {
                history.push(`/invest/${currencyIdA ? currencyIdA : 'ETH'}/${newCurrencyIdB}`, )
            }
        },
