    ...
    constructor(props) {
        ...
        this.state = {
            ...
            options: {
                        ...
                        return `
                            <div class="chart__tooltip d-flex flex-column justify-content-between">
                                <div class="d-flex flex-column mb-3">
                                    ...
                                    <span class="chart__tooltip-value">$${Number(value)?.toFixed(4)}</span>
                                </div>
                ...
                fill: {
                    gradient: {
                        opacityFrom: props.isPrimary ? 0.55 : 0,
                        opacityTo: 0
                    }
                },
                padding: {
                ...
                legend: {
                    ...
                    itemMargin: {
                        horizontal: isMobile ? 15 : props.isPrimary ? 15 : 7,
        ...
        return (
            <ChartWrapper id="chart" className={this.props.isPrimary ? 'primary-chart' : ''}>
                ...
                <ChartBody isPrimary={this.props.isPrimary}>
                    {this.props.loading ? (
                        <div className="d-flex align-items-center justify-content-center py-5 w-100" style={{ minHeight: this.props.minHeight || isMobile ? this.props.isPrimary ? 423 : 293 : 350 }}>
                            <Loading width={40} height={40} color={this.props.variant} active id={'historical-' + this.props.variant}/>
                        </div>
                    ) : (
                        <ReactApexChart options={this.state.options} series={this.state.series} type="area" height={this.props.minHeight || isMobile ? this.props.isPrimary ? 423 : 293 : 350} />
                    )}
                </ChartBody>
            </ChartWrapper>
