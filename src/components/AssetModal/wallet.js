    ...
    return (
        <Modal
            ...
            <Modal.Body className={'py-3'}>
                <div>
                    <table className="table table-borderless mb-0 table-head-custom table-hover ">
                        <thead>
                            <th>Assets</th>
                            <th>Balance</th>
                        ...
                        {data.map(row => {
                                return (
                                    <tr key={row.metadata.address} className={'assets__row'} style={{ cursor: 'pointer' }} onClick={onClickToken.bind(this, row)}>
                                        <td>
