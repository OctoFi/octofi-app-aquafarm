    ...
    return (
        <Wrapper>
            ...
            <PaddedColumn gap="md">
                ...
                <Card
                    style={{ backgroundColor: fromLists ? transparentize(0.8, theme.warning) : transparentize(0.8, theme.red1) }}
                >
                    ...
                    <AutoRow justify="center" style={{ cursor: 'pointer' }} onClick={() => setConfirmed(!confirmed)}>
                        ...
                        />
                        <TYPE.body ml="10px" fontSize="16px" color={fromLists ? theme.warning : theme.red1} fontWeight={500}>
