            ...
            <Wrapper>
                <Header className="d-flex align-items-start justify-content-between">
                    <div className={'d-flex align-items-start mb-10'}>
                        <LogoContainer>
                            {props.imageComponent ? props.imageComponent : props.img ? (<Logo src={props.img} alt={props.name}/>) : <CurrencyLogo currency={props.currency}/>}
                        </LogoContainer>
                ...
                {props.src && (
                    <div className="d-flex d-md-none flex-column align-items-stretch justify-content-center" style={{ marginTop: 24 }}>
